...
export default class AwesomeFeatures extends React.Component {
	constructor() {
		super();
	}
	render() {
					...
					<div class="row">
						<div class="col-sm-6 col-xl-3 align-self-center">
							<div class="single_feature_text ">
								...
								<p>
									Set have great you male grass yielding an yielding first their you're have called
									the abundantly fruit were man{' '}
								</p>
								<a href="#" class="btn_1">
									Read More
								</a>
